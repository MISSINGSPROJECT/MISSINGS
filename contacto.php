      ...
      <div class="container-fluid">
          ...
          <div class="col-lg-4 col-11">
            <div class="tm-brand-container tm-bg-white-transparent">
              ...
              <div class="tm-brand-texts">
                <img src="img/logo_missings2.jpeg" width="400" height="200" alt="logo_missings2"/>
              ...
              <nav class="navbar navbar-expand-lg navbar-light tm-bg-white-transparent tm-navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                      <div class="tm-nav-link-highlight"></div>
                      <a class="nav-link" href="que%20es%20missings.php">¿QUE ES MISSINGS?</a>
                    </li>
                    <li class="nav-item">
                      <div class="tm-nav-link-highlight"></div>
        ...
        <section class="row tm-contact-row">
            <div class="col-lg-6 tm-contact-col-left">
                <form action="#" method="POST" id="tmContactForm" class="tm-bg-black-transparent tm-contact-form">
                  ...
                  <div class="form-group">
                    <textarea rows="6" id="contact_message" name="contact_message" class="form-control rounded-0 border-top-0 border-right-0 border-left-0" placeholder="Mensaje" required=""></textarea>
                  </div>
            ...
            <div class="col-lg-6 tm-contact-col-right">
                <div class="tm-bg-black-transparent tm-contact-text">
                    ...
                    <h3 class="tm-service-tab-title">MISSINGS</h3>
        ...
        <section class="row tm-testimonials-cta" id="tmCallToAction">
          <div class="col-12 tm-call-to-action-col">
            <img src="img/contacto1.jpg" width="1000" height="400" alt="Image"class="call-to-action"/>
            <div class="tm-bg-white tm-call-to-action-text">
              <h2 class="tm-call-to-action-title">Atencion al cliente</h2>
        ...
        <footer class="row">
          <p class="col-12 text-white text-center tm-copyright-text">
            Copyright &copy; 2021 App Landing Page. 
            Designed by <a href="#" class="tm-copyright-link">MISSINGS</a>
          </p>
        </footer>
      </div>
      <!-- .container-fluid -->
